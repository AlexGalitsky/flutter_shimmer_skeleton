...
void main() {
  group('Shimmer Widget Tests', () {
    ...
    testWidgets('Shimmer.of returns null when no ancestor', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('Shimmer.of returns state when ancestor exists', (
      WidgetTester tester,
    ) async {
  ...
  group('ShimmerLoading Widget Tests', () {
    testWidgets('ShimmerLoading shows child when not loading', (
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: ShimmerLoading(isLoading: false, child: Text('Content')),
        ),
      );
    ...
    testWidgets(
      'ShimmerLoading shows shimmer when loading without Shimmer ancestor',
      (WidgetTester tester) async {
        await tester.pumpWidget(
          const MaterialApp(
            home: ShimmerLoading(isLoading: true, child: Text('Content')),
          ),
        );
  ...
  group('Skeleton Widgets Tests', () {
    testWidgets('SkeletonBox builds correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: SkeletonBox(width: 100, height: 50)),
        ),
      );
    ...
    testWidgets('SkeletonText builds correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: SkeletonText(lines: 3, lineHeight: 16)),
        ),
      );
    ...
    testWidgets('SkeletonListItem builds correctly', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(
            body: SkeletonListItem(hasAvatar: true, hasSubtitle: true),
          ),
        ),
      );
    ...
    testWidgets('SkeletonCard builds correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: SkeletonCard(hasImage: true, hasText: true)),
        ),
      );
